...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        toolbar.setTitle("Nagrywanie dzwieku");
    ...
    public void setInfo(){
        ...
        voiceMessage.setName( name.getText().toString());
        voiceMessage.setSurname( surname.getText().toString());
        voiceMessage.setTitle( title.getText().toString());
        voiceMessage.setInfo( info.getText().toString());
        Date c = Calendar.getInstance().getTime();
        SimpleDateFormat df = new SimpleDateFormat("dd-MMM-yyyy-HH-mm-ss");
        String formattedDate = df.format(c);
        voiceMessage.setDate(formattedDate);
    }
    ...
    private void startRecording() {
        ...
        fileName =  root.getAbsolutePath() + "/VoiceRecorderSimplifiedCoding/Audios/" + String.valueOf(voiceMessage.getName()+ " " + voiceMessage.getSurname()+ " " + voiceMessage.getTitle()+ " " + voiceMessage.getInfo() +  " " + voiceMessage.getDate() + ".mp3");
