...
public class RezerwacjaDlaSiebie extends AppCompatActivity {

    DatePickerDialog datePicker;
    TimePickerDialog timePicker, timePicker2;
    EditText et_data, et_godzRoz, et_godzZak;
    Button btn_cofnij;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dlasiebielayout);
        init(Integer.parseInt(getIntent().getStringExtra("nrStolika")));
        final UserSession user = new UserSession(RezerwacjaDlaSiebie.this);
        ...
        et_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePicker = new DatePickerDialog(RezerwacjaDlaSiebie.this,
        ...
        et_godzRoz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                minRoz = minutes;
                timePicker = new TimePickerDialog(RezerwacjaDlaSiebie.this,
        ...
        et_godzZak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                minZak = minutes2;
                timePicker2 = new TimePickerDialog(RezerwacjaDlaSiebie.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker tp, int sHour, int sMinute) {
        ...
        btn_cofnij.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RezerwacjaDlaSiebie.this, Rezerwacja.class);
        ...
        btn_confirme.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String imie2 = userProfil[0];
                String nazwisko2 = userProfil[1];
                ...
                if(data.equals("") || godzinaRoz.equals("") || godzinaZak.equals("")){
